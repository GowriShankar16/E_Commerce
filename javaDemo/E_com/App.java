...
import javaDemo.DAO.UserDAO;
		...
		public class App {
		 ...
		 addressbo.saveaddress(address_3); 
			Product product_1= new Product("Shoe",2500.00,"blue","fila");
			Product product_2 = new Product("Mobile",12000.00,"Silver","Redmi");
			Product product_3 = new Product("Watch",2000.00,"Black","Fastrack");
			ProductBO productbo =new ProductBO();
			productbo.saveproduct(product_1);
			productbo.saveproduct(product_2);
			productbo.saveproduct(product_3);*/
		   ...
		   switch (Integer.parseInt(br.readLine())){
		    ...
		    //Address
		     case 2:
		    	...
		    	//product    
		          case 3:  
		        	    System.out.println("1.Create Product/n"+"2.Update Product/n");     	    	 
			    	    switch (Integer.parseInt(br.readLine())) {
				        ...
				        case 1:
				        	  do {
				        	    ...
				        	    System.out.println("Do you want to continue to add another product Yes/No");
				              }while(br.readLine().equalsIgnoreCase("yes"));
				       
				        case 2:
                              Integer count3 =0;
				              do {
		   	                    System.out.println("Enter the product name to update a Product \n");
		   			            String productCheck=br.readLine();
		                        if(productbo.checkproduct(productCheck)==null) {
		   	                    	System.out.println("The product does not exist");
			                    	count3=0;
			                        }
		   			            else {
		   			                count3=1;
		   			              	Product stockUpdate =productbo.checkproduct(productCheck);
		   			              	System.out.println("Enter the quantity to update product");
		   		                  	Integer quantity =Integer.parseInt(br.readLine());
		   	                    	stockUpdate.setquantity(stockUpdate.getQuantity()+quantity);
			                    	productbo.saveproduct(stockUpdate);
		   			                        }System.out.println("Do you want to  update Stock for any other product Yes/No");
		   		                      } while(br.readLine().equalsIgnoreCase("yes"));
				        		  break;
		         }
			...
			private static void checkUserName(User user)throws Exception {
				...
				do {
					...
					if(checkName) {
						System.out.println("UserName already exist enter the another name ");
					}
					else
					{
